...
class UIClass(customtkinter.CTk):
    def __init__(self, title, size):
        # main setup
        super().__init__()
        self.geometry(f"{size[0]}x{size[1]}+500+500")
    ...
    def start_rps(self):
        ...
        '''
        # disable entering/sending more text
    ...
    def stop_rps(self):
        # enable entering/sending more text
...
class Main(customtkinter.CTkFrame):
    def __init__(self,parent):
        ...
        # creating entry + textbox here for easy access
    ...
    def make_widgets(self, main_frame):
        ...
        self.entry.bind("<Return>", lambda event: self.send_entry(event))
...
class RockPaperScissors(customtkinter.CTkToplevel):
    def __init__(self):
        ...
        self.queued = False
        self.hand = ""
        self.protocol("WM_DELETE_WINDOW", self.cancel_rps)
